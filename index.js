...
const token = 'NzQ4NzQ2MjQ5MjA0NzkzMzg1.X0h6SA.SNhcyjreO5sHGpe0jT7p4NDvfRA'; // ' 이쪽이 봇 토큰 '
...
client.on('message', (message) => {
  if(message.content === '&출근') {
    let img = 'https://cdn.discordapp.com/attachments/749493497714966528/749795751269367858/unknown.png'; // 임베드에 나오는 사진
    let embed = new Discord.RichEmbed()
      .setTitle('문의가 가능합니다')// 한번 켜보시고 테스트 하면서 원하는대로 수정하심됩니다
      .setThumbnail(img)
      .setDescription(` <@${message.author.id}> ` + '님 , ** 정상적으로 출근하셨습니다 **') //  <@${message.author.id}> 이 구문은 사용자를 태그하는 구문입니다 손대시면 오류뜹니다 , + 뒤에 있는건 수정하셔도 됩니다 
      .setTimestamp()
      .setFooter('MADE BY.死 쿠나#4444', img) // 제작자 ( 수정금지 )
  ...
  if(message.content === '&임시퇴근') {
    let img = 'https://cdn.discordapp.com/attachments/749493497714966528/749795751269367858/unknown.png';
    let embed = new Discord.RichEmbed()
      .setTitle('문의가 가능합니다')
      .setThumbnail(img)
